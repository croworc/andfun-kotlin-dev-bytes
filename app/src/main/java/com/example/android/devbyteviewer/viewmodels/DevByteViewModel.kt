...
/**
 * DevByteViewModel is designed to store and manage UI-related data in a lifecycle conscious way.
...
class DevByteViewModel(application: Application) : AndroidViewModel(application) {
    ...
    private val videosRepository = VideosRepository(db)
